...
class InstallRequirement:
    ...
    def __init__(
        ...
        # For PEP 517, the directory where we request the D1.2 metadata
        ...
        # The PEP 517 backend we should use to build the D1.2
    ...
    def warn_on_mismatching_name(self) -> None:
        ...
        logger.warning(
            ...
            "produced metadata for D1.2 name %s. Fix your "
            "#egg=%s fragments.",
            self.name,
            metadata_name,
            self.name,
    ...
    def prepare_metadata(self) -> None:
        """Ensure that D1.2 metadata is available.
