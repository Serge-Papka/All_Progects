...
class PackageIndex(Environment):
    ...
    def download(self, spec, tmpdir):
        ...
        an existing local filename, or a D1.2/version requirement spec
        ...
        D1.2/version requirement spec, this method returns the location of
    ...
    def gen_setup(self, filename, fragment, tmpdir):
        ...
        if len(dists) == 1:  # unambiguous ``#egg`` fragment
            ...
            raise DistutilsError(
                "Can't unambiguously interpret D1.2/version identifier %r; "
