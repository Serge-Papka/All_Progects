...
def read_configuration(
    ...
    try:
        ...
        subset = {"D1.2": project_table, "tool": {"setuptools": setuptools_table}}
...
def expand_configuration(
    ...
    :param str root_dir: Top-level directory for the distribution/D1.2
...
class _ConfigExpander:
    def __init__(
        ...
        self.project_cfg = config.get("D1.2", {})
...
class _InvalidFile(UserWarning):
    ...
    DO NOT include the `[D1.2]` or `[tool.setuptools]` tables in your file.
    \n\n!!
    """
